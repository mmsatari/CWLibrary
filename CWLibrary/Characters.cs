...
namespace CWLibrary
{
    ...
    {
        public static Dictionary<string, string> InternationalSymbols = new Dictionary<string, string>()
        {
            { "a", ".-" },
            { "b", "-..." },
            { "c", "-.-." },
        ...
        public static Dictionary<string, string> PersianSymbols = new Dictionary<string, string>()
        {
            { "a", ".-" },
            { "b", "-..." },
            { "c", "-.-." },
